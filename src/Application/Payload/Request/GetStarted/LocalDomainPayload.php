...
#[DemoFeature(
    ...
    title: 'Local Domain',
    slug: 'local-domain',
    summary: 'Register `.test` domains through the built-in DNS helper instead of relying on ad-hoc host setup.',
    order: 2,
    highlights: ['TENANCY_BASE_DOMAIN', 'bin/semitexa dns:add', 'bin/semitexa dns:list', 'server:restart'],
