...
#[AsResource(handle: 'demo_blog_streaming_sse', template: '@project-layouts-semitexa-demo/pages/blog-streaming-sse.html.twig')]
final class BlogStreamingSseResource extends HtmlResponse implements ResourceInterface
{
    use HasDemoShell;
