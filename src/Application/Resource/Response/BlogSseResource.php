...
#[AsResource(handle: 'demo_blog_sse', template: '@project-layouts-semitexa-demo/pages/blog-redirect.html.twig')]
final class BlogSseResource extends HtmlResponse implements ResourceInterface
{
    use HasDemoShell;
