            ...
            ->withResultPreviewTemplate('@project-layouts-semitexa-demo/components/previews/cli-command-workbench.html.twig', [
                ...
                'pillars' => [
                    ...
                    [
                        ...
                        'summary' => 'contracts:list and semitexa:lint:* help debug DI bindings and architectural invariants before runtime incidents.',
                    ],
                ],
                'commands' => [
                    [
                    ...
                    [
                        'name' => 'bin/semitexa routes:list --json',
                        'purpose' => 'List all discovered routes with source metadata.',
                        'value' => 'Gives a stable route inventory instead of relying on tribal knowledge.',
                    ],
                    [
                        'name' => 'bin/semitexa contracts:list --json',
                        'purpose' => 'Show service contracts and their active implementation.',
                        'value' => 'Shortens DI debugging when multiple modules can satisfy the same interface.',
                    ],
                    [
                        'name' => 'bin/semitexa semitexa:lint:handlers',
                        'purpose' => 'Validate handler signatures, bindings, and return types.',
                        'value' => 'Catches architecture drift before it becomes a runtime failure.',
                    ],
                ],
                'snippets' => [
                    [
                    ...
                    [
                        ...
                        'code' => "bin/semitexa contracts:list --json\nbin/semitexa semitexa:lint:handlers",
                    ],
                ],
            ])
