...
final class InstallationHandler implements TypedHandlerInterface
{
    ...
    public function handle(InstallationPayload $payload, DemoFeatureResource $resource): DemoFeatureResource
    {
        $explanation = [
            ...
            'how' => 'The installer scaffolds the project, writes `.env.default` as the committed baseline, uses `.env` for local overrides, and hands runtime control to `bin/semitexa` for boot, verification, and inspection.',
            ...
            'keywords' => [
                ...
                ['term' => '.env', 'definition' => 'Optional local overrides. Create it only when this workstation needs values different from the shared baseline.'],
        ...
        return $resource
            ...
            ->withHighlights(['install.sh', '.env.default', '.env', 'bin/semitexa', 'self-test', 'routes:list'])
