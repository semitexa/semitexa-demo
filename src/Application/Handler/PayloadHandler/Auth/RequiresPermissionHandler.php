...
final class RequiresPermissionHandler implements TypedHandlerInterface
{
    ...
    public function handle(RequiresPermissionPayload $payload, DemoFeatureResource $resource): DemoFeatureResource
    {
        ...
        $sourceCode = [
            'Guarded Payload' => $this->sourceCodeReader->readProjectRelativeSource('packages/semitexa-demo/src/Application/Examples/Auth/RequiresPermission/ManageUsersPayload.example.php'),
            'Guarded Handler' => $this->sourceCodeReader->readProjectRelativeSource('packages/semitexa-demo/src/Application/Examples/Auth/RequiresPermission/ManageUsersHandler.example.php'),
        ];
