...
final class SharedTableExtensionHandler implements TypedHandlerInterface
{
    ...
    public function handle(SharedTableExtensionPayload $payload, DemoFeatureResource $resource): DemoFeatureResource
    {
        ...
        return $resource
            ...
            ->withSourceCode([
                'Catalog Module Resource' => $this->sourceCodeReader->readProjectRelativeSource('packages/semitexa-demo/src/Application/Examples/Orm/SharedTable/CatalogProductResource.example.php'),
                'Merchandising Module Extension' => $this->sourceCodeReader->readProjectRelativeSource('packages/semitexa-demo/src/Application/Examples/Orm/SharedTable/MerchandisingProductExtension.example.php'),
